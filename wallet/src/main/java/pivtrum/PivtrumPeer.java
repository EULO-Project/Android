...
public class PivtrumPeer implements IoHandler {
    ...
    public PivtrumPeer(UloNodeData peerData, IoManager ioManager, VersionMsg versionMsg) {
     ...
     *
     */
    private void subscribeHeight() throws JSONException {
     ...
     * @param addresses
     */
    public void subscribeAddresses(Set<String> addresses) throws JSONException {
     ...
     * @param address
     */
    public void listUnspent(String address) throws JSONException {
     ...
     * @param txHash
     */
    public void getTx(String txHash) throws JSONException {
        log.info("onGetTx");
        WriteFuture writeFuture = new WriteFutureImp();
        sendMsg(
                new GetTxMsg(txHash),
    ...
    private WriteRequest sendMsg(BaseMsg baseMsg, boolean singleRequest, WriteFuture writeFuture) throws JSONException {
    ...
    private void receiveVersion(JSONObject serverVersion) throws JSONException {
    ...
    private void receivePeers(JSONObject jsonObject) throws JSONException {
        log.info("receive peers");
        //todo: save peers
        jsonObject.getJSONArray("result");
    }

    private void receiveAddress(JSONObject jsonObject, String address) throws JSONException {
    ...
    private void receiveUnspents(JSONObject jsonObject, ListUnspentMsg msg) throws JSONException {
    ...
    private void receiveSubscribeHeight(JSONObject jsonObject) throws JSONException {
    ...
    private void receiveGetBalance(JSONObject jsonObject,GetBalanceMsg msg) throws JSONException {
    ...
    private void receiveHistory(JSONObject jsonObject,String address) throws JSONException {
    ...
    private void msgArrived(JSONObject jsonObject) throws JSONException {
    ...
    public UloNodeData getPeerData() {
        return peerData;
    }
