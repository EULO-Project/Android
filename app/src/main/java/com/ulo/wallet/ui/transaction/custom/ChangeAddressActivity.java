        ...
        findViewById(R.id.btnOk).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    e.printStackTrace();
                    DialogsUtil.buildSimpleErrorTextDialog(ChangeAddressActivity.this, getString(R.string.invalid_inputs), getString(R.string.invalid_input_address)).show(getFragmentManager(), "custom_change_address");
                }
            }
        });
