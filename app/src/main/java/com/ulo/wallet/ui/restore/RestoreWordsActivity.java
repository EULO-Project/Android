...
//                                            pivxModule.restoreWallet(mnemonic, PIVX_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME, !isBip32);
                                            ...
                                            pivxModule.restoreWallet(mnemonic);
...
//                                                 Check if the pin has been set
                                                    if (pivxApplication.getAppConf().getPincode() != null) {
                                                        ...
                                                        Intent intent=new Intent(RestoreWordsActivity.this, PincodeActivity.class);
                                                        intent.putExtra(PincodeActivity.RESTORE_SET_PIN,PincodeActivity.RESTORE_SET_PIN);
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position == 0) {
                ...
                txtWord5.setVisibility(View.GONE);
                txtWord6.setVisibility(View.GONE);
                txtWord7.setVisibility(View.GONE);
                txtWord8.setVisibility(View.GONE);
                ...
                txtWord13.setVisibility(View.GONE);
                txtWord14.setVisibility(View.GONE);
                txtWord15.setVisibility(View.GONE);
                txtWord16.setVisibility(View.GONE);
                ...
                txtWord21.setVisibility(View.GONE);
                txtWord22.setVisibility(View.GONE);
                txtWord23.setVisibility(View.GONE);
                txtWord24.setVisibility(View.GONE);
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, UloContext.ENABLE_BIP44_APP_VERSION));
